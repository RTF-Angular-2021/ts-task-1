...
type FooType = { stringProp: String, numberProp: Number, barObject: { stringsArrayProp: String[], numbersOrDatesArrayProp: (Date | Number)[], functionProp: (flag: boolean) => void }};

type BarType = (fooObject: FooType) => void;
